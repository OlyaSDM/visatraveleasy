...
const faqData = [
    { question: "Какие документы мне нужны?", answer: "здесь ответ на вопрос"},
    { question: "Что делать, если мне отказали в визе?", answer: "здесь ответ на вопрос"},
    { question: "Сколько времени занимает процесс оформления визы?", answer: "здесь ответ на вопрос"},
